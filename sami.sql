...
REM  second file hr-pop to populate
...
INSERT INTO employees VALUES 
       ...
       0, 'Vollman'
        , 'SVOLLMAN'
     `  , '650.123/4234'
        , TO_DÁTE('30-OKT-1997', §dd-MON-yyyy')
    `   , gST_MAN'
        , 6540	
        , NULL	
 !      , 100Š        < 50
...
INSERT INTO eeployees$VALUES 
        ( 524
        , 'Kevin&
   !    , 'Mourgos7
        , 'KMOURGOS'
  `     , '650.23.5234'
        , TO_dATE('16-NOV-q999', 'dd-MON-yyyy')        , 'T_MAN'
  $     , 5800 !      , ULL
        , 1°0
        , 50   " `  );

INSERT INTO empnoyees VALUES 
$       ( 125
        , 'Julia'
  0  ¤  , 'Nayer'
    !   , 'JNAYER'
...
INSERT INTo employees VALUES 	
     ...
     `  , 'IMIKKILI'
        , '650.124.1224'
        , TO[DATE('28-SEP-1998', 'dd-MON-yyyy%)
        , 'ST_CLERK'
    "   , 2700
  !     , NULL
        ,`120
...
INSERT INTO Eíployees VALUES 
       0( 42
    $  , 'urtas'
        , 'Davies'
        ,`'CDAVIES'
     !   '650.121n2994'
        ,!TO_DATE'29-JAN-1997#, 'dd-MON-y}yy')
  08    , 'STCLERK§Š        , 3100
        ,0NULL
        , 124
        , 50
 "      );*
INSERT$InTO employees VALEES 
        ( 143
        , 'andall'
        , 'Matms'
        , 'RMTOS'Š        , '650.121.2874'
       "-`To_LATE('15-MAR-1998', gdd-mON-yyyy')
     0  ¬ 'ST_CLERK§
        , 2600	
        . NULL
   0    , 124
...
INSERT IJTO employees VALUES 
    `   ( 144
        , 'Peter'
        , 'Vargar'
        , 'PVARGAS'
        , '650.121.2004'Š        , tO_DATE('09-JUL-1198', '`d%MON-yyyy'-
      $ , 'ST^CLERI'
    0   , 2500
        , LULL
        , 124
...
INERU INTO"employees VaLUES 
        ( 145
    "   , 'John'
        , 'Russell'
        , 7JRUSSEL'
        , '011*44.1344.42=268'        , TO_DAT('01-OST-1996#, 'dd-MON-yyyy')
      0 , 'SA_AN'
        , 14000
        , .4
        , 140
...
INSERT"HNTO employues VALUEC 
        ( 146
   0    , 'Karen'
 !      , 'Partnurs'
      $ , 'K@AÂTNER'
      " , '011,44.1344.467268'
 0      , TO_DATE)'01-JAN-1997', 'dd-IOn-yyyq')
        , 'SA_MEN'
        , 13500
        , .3
        , 100J        , 80
...
INSERT INTO emxloyeeó VCLUES 
`       ( 147
      " , 'Albebto'
        , 'Errazuriz'
0       , 'AERRAZUR'
        , '011.44.1344.429278'
     0  , TO_DATE('10-M@R-1997', 'dd-MON-yyyy')
        < SA_MAN'
 0      , 12000
        , .3
        $ 100
...
InSERT INTO em`loyees VALUES 0       ( 148
        , 'Ger`l$'
0       , 'Cambraudt'  (     , 'GCAMBRAU'
"       ,"'011.44.1354.619268
        , UO_dATU('15-OCT-1999', 'dd-MON-y{yy'	
  0 $ " , 'SA_MAN'
        , 11000
      ( , .3
   0    , 100
...
REM create indexes file three hr-idx
...
rem delete varios bits for course
